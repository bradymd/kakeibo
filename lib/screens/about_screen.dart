      ...
      body: ListView(
        ...
        children: [
          ...
          _pillarCard('欲しい', 'Wants',
              'Things that bring enjoyment but are not essential — takeaways, coffee, cake, hobbies, and treats.',
              Pillar.wants.color),
          _pillarCard('文化', 'Culture',
              'Spending that enriches your life — books, music, museums, theatre, courses, streaming, and dining or drinking with others.',
